...
class TAO_OW(_BaseDataset):
    ...
    def _split_known_unknown_distractor(self):
        ...
        self.distractors = {513, 529, 1169, 403, 20, 407, 798, 415, 1184, 672, 813, 303, 815, 691, 180, 567, 569, 827,
                            188, 702, 831, 63, 1220, 708, 711, 971, 204, 588, 851, 212, 736, 737, 490, 1130, 108, 1133,
                            1134, 877, 883, 247, 507, 126}
