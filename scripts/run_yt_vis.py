...
if __name__ == '__main__':
    ...
    default_dataset_config = hm.datasets.YouTubeVisMask.get_default_dataset_config()
    ...
    dataset_list = [hm.datasets.YouTubeVisMask(dataset_config)]
    metrics_list = []
    for metric in [hm.metrics.TrackMAP, hm.metrics.HOTA, hm.metrics.CLEAR, hm.metrics.Identity]:
        if metric.get_name() in metrics_config['METRICS']:
            if metric == hm.metrics.TrackMAP:
